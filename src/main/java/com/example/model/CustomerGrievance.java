...
public class CustomerGrievance {
	...
	public CustomerGrievance(Long grievanceId, CustomerCardAccount customerCardAccount, String subject,
			String description, Date timestamp, ResolutionStatus status) {
		super();
		this.grievanceId = grievanceId;
		this.customerCardAccount = customerCardAccount;
		this.subject = subject;
